...
def Write_Atom_in(E_name, Z_Val):
      ...
      AtomPAW_In = ''' 
LDA-PW scalarrelativistic loggridv4 5001 14.2 2.05 loggderivrange -25. 25. 2500
2 2 0 0 0 0
2 1 4
0 0 0
c
...
v
1
1.35  1.27   1.27    1.27 # 1.85 1.51 1.54 1.51
y
-0.65   # -0.70 能量往大调压制波函数
n
y
0.60    # 0.05 能量往大调压制波函数
n
...
#    os.system("evince *-data.ps")
    os.system("cat in > O.in")
    os.system("cat in > O_orig.in")
